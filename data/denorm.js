const Hymn = require('./../dest/models');

let fs = require('fs');
let hymns = JSON.parse(fs.readFileSync('data/json/hymns.json'));
let category = JSON.parse(fs.readFileSync('data/json/category.json'));
